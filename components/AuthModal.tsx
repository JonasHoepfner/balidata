  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={handleClose}
          style={{ position: 'absolute', top: 16, right: 18, background: 'none', border: 'none', color: '#4A4540', fontSize: 22, cursor: 'pointer', lineHeight: 1, padding: '2px 6px' }}
        >
          ×
        </button>

        {/* Logo */}
        <div style={{ textAlign: 'center', fontFamily: 'var(--font-dm-mono)', fontSize: 14, color: '#C4A882', letterSpacing: '0.14em', marginBottom: 20 }}>
          BALIDATA
        </div>
